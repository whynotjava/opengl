...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "openGl tests and other shit I do", NULL, NULL);
	...
	Shader lightShader("../res/shaders/light-vert.txt", "../res/shaders/light-frag.txt");
